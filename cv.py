...
prelude = """
        ...
        Assess the provided CV text, providing a list of ten or less common words or phrases, along with improved verisons of each,
        which would help the CV to stand out in a professional setting.
        ...
        JSONIFY the output into an array of points called "suggestions".
    ...
    if file:
        ...
        try:
            ...
            return json.loads(
                ...
                .create(model="gpt-4o", messages=[prompt])
                .choices[0]
                .message.content
            )
